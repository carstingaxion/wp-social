...
<div class="social-comment-inner social-clearfix" id="comment-<?php comment_ID(); ?>">
	<div class="social-comment-header">
		...
		<div class="social-comment-meta">
			...
			<a href="<?php echo esc_url(get_comment_link(get_comment_ID())); ?>" class="social-posted-when" target="_blank"><?php echo esc_html(sprintf(__('%s ago', 'social'), Social_Date::span_formatted(strtotime($comment->comment_date_gmt)))); ?></a>
			<a href="<?php echo esc_url(get_comment_link(get_comment_ID())); ?>" class="social-posted-when" target="_blank"><?php echo esc_html(sprintf(__('%s ago', 'social'), Social_Date::span_comment(strtotime($comment->comment_date_gmt)))); ?></a>
		</div>
	</div>
